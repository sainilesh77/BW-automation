...
describe('Contact Contents verification', () => {
    before(() => {
        ...
        cy 
        .visit('/')
        cy.get('.ant-menu-title-content > span > a').should('be.visible').contains('Contact').click()
    ...
    it('Contact Container', () => {
        cy.get('.contactContainer').should('be.visible')
    })

    it('General Enquiry Form', () => {
    ...
    it('Career Banner', () => {
        cy.get('.careersBannerSec').scrollIntoView().should('be.visible')
    })
